...
<form action="codegeneration.php" method="POST" autocomplete="off">
<input type="text" class="input" id="input" name="codetobedecoded" required/>
<input type="submit" class="submit"  style="margin-top:200px;"value="SUBMIT">
</form>
<a class="text1" href="qr1.php">QR-CODE</a>
          </div>
        <!--  <div class="s1">
       <form>
